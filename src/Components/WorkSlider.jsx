    ...
    >
          ...
          <SwiperSlide >
            <div className="grid grid-cols-2 grid-rows-2 gap-4 lg:mx-20 cursor-pointer ">
                  ...
                  <Link to="https://glistening-hamster-d523f1.netlify.app/" target="_blank" rel="noopener noreferrer"
       ...
       >
         <div className="relative rounded-lg overflow-hidden
                  ...
                  <Link to="https://grand-starburst-57dd90.netlify.app/"target="_blank" rel="noopener noreferrer"
       ...
       >
         <div className="relative rounded-lg overflow-hidden
                  ...
                  <Link to="https://jocular-bunny-1b96c3.netlify.app/" target="_blank" rel="noopener noreferrer"
       ...
       >
         <div className="relative rounded-lg overflow-hidden
                  ...
                  <Link to="https://ciudad-caribia.netlify.app/" target="_blank" rel="noopener noreferrer"
       ...
       >
         <div className="relative rounded-lg overflow-hidden
                  ...
                  <Link to="https://symphonious-daffodil-7ceace.netlify.app/"target="_blank" rel="noopener noreferrer"
       ...
       >
         <div className="relative rounded-lg overflow-hidden
                  ...
                  <Link to="https://zesty-paprenjak-d18218.netlify.app/" target="_blank" rel="noopener noreferrer"
