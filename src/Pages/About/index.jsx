          ...
          <div className="h-full bg-primary/30 py-32 text-center xl:text-left">
            ...
            >
              ...
              className="flex-1 flex flex-col justify-center gap-y-1">
               ...
               animate="show"
               exit="hidden"
               className="max-w-[500px] mx-auto xl:mx-0 mb-6 xl:mb-12 px-2 xl:px-0">10 years ago, i began freelancin as a developer. Since then, I´ve done 
                remote work for agencies, counsulted for startups, and collaborated on digital products 
